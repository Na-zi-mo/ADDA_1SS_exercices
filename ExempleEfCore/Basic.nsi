...
Section "Jardinage" SecComp1

  SetOutPath "$INSTDIR\bin"
  
  ;Ajouter les fichiers à installer
  File /r "JardinageWpf\bin\Release\net8.0-windows\publish\win-x64\"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$DossierMenuDemarrer\Jardinage.lnk" "$INSTDIR\bin\JardinageWpf.exe"
...
;Les traductions
  ...
  LangString DESC_SecComp1 ${LANG_FRENCH} "Permet la gestion des plantes du jardin"
  LangString DESC_SecComp1 ${LANG_ENGLISH} "Let you manage your garden plants"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\$DossierMenuDemarrer\Jardinage.lnk"
